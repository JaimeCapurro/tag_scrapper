//Este Archivo extrae los datos del segundo convenio
...
const costNorte2 = async () => {
  ...
  await page.goto("https://costaneranorte.cl/sucursal_virtual/login.html");
          ...
          if (docs == 0) { //define si es que hay una tabla con datos a extraer
            ...
            while (!sonIguales) {
              ...
              autos.each((i, el) => {
                ...
                const getConcesion = "Costanera Norte";
                data.push({
                  patente: getPatente,
                  fecha: getFecha,
                  hora: getHora,
